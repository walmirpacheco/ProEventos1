...
namespace ProEventos1.API.Controllers
{
    ...
    {  
        ...
        {            
            ...
            {                
                return this.StatusCode(StatusCodes.Status500InternalServerError, $"[ERRO!] Erro ao tentar recuperar palestrantes. Erro: {ex.Message}");
            }            
        }
        ...
        {            
            ...
            {                
                return this.StatusCode(StatusCodes.Status500InternalServerError, $"[ERRO!] Erro ao tentar recuperar palestrante. Erro: {ex.Message}");
            }
