...
namespace ProEventos1.API.Controllers
{
    ...
    {  
        ...
        {            
            ...
            {                
                return this.StatusCode(StatusCodes.Status500InternalServerError, $"[ERRO!] Erro ao tentar recuperar Rede Social por Evento. Erro: {ex.Message}");
            }            
        }
        ...
        {            
            ...
            {                
                return this.StatusCode(StatusCodes.Status500InternalServerError, $"[ERRO!] Erro ao tentar recuperar Rede Social por Palestrante. Erro: {ex.Message}");
            }            
        }  
        ...
        public async Task<IActionResult> SaveByEvento(int eventoId, RedeSocialDto[] models)
        {
            ...
            {                
                return this.StatusCode(StatusCodes.Status500InternalServerError, $"[ERRO!] Erro ao tentar salvar Rede Social por Evento. Erro: {ex.Message}");
            }
        }
        ...
        public async Task<IActionResult> SaveByPalestrante(RedeSocialDto[] models)
        {
            ...
            {                
                return this.StatusCode(StatusCodes.Status500InternalServerError, $"[ERRO!] Erro ao tentar salvar Rede Social por Palestrante. Erro: {ex.Message}");
            }
        }
        ...
        public async Task<IActionResult> DeleteByEvento(int eventoId, int redeSocialId)
        {
            try
            {
                ...
                return await _redeSocialService.DeleteByEvento(eventoId, redeSocialId) 
                    ...
                    : throw new Exception("[ERRO!] Ocorreu um problema não especificado ao tentar deletar Rede Social por Evento!");                
            }
            catch (Exception ex)
            {                
                return this.StatusCode(StatusCodes.Status500InternalServerError, $"[ERRO!] Erro ao tentar deletar Rede Social por Evento. Erro: {ex.Message}");
            }
        }
        ...
        public async Task<IActionResult> DeleteByPalestrante(int redeSocialId)
        {
            try
            {
                ...
                return await _redeSocialService.DeleteByPalestrante(palestrante.Id, redeSocialId) 
                    ? Ok(new { message = "Rede Social Deletada!"}) 
                    : throw new Exception("[ERRO!] Ocorreu um problema não especificado ao tentar deletar Rede Social por Palestrante!");                
            }
            catch (Exception ex)
            {                
                return this.StatusCode(StatusCodes.Status500InternalServerError, $"[ERRO!] Erro ao tentar deletar Rede Social por Palestrante. Erro: {ex.Message}");
            }
        }
